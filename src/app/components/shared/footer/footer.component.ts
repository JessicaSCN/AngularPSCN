...
export class FooterComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    $(function() {
      ($('.your-class') as any).slick({ arrows: false });
      // tslint:disable-next-line: only-arrow-functions
      ($('#next') as any).click(function() {
        ($('.your-class') as any).slick('slickNext');
      });
      // tslint:disable-next-line: only-arrow-functions
      ($('#prev')as any).click(function() {
        ($('.your-class') as any).slick('slickPrev');
      });
    });
  }
}
